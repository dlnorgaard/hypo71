package gov.usgs.volcanoes.hypo71;
...
public class ControlCard {
  ...
  public ControlCard(int kSING, double zTR, double xNEAR, double xFAR, double pOS, int iQ, int kMS,
      int kFM, int iPUN, int iMAG, int iR, int iPRN, int kPAPER, int kTEST, int kAZ, int kSORT,
      int kSEL, int lAT1, int lAT2, double lON1, double lON2) {
    KSING = kSING;
    ZTR = zTR;
    XNEAR = xNEAR;
    XFAR = xFAR;
  ...
  public ControlCard(Properties properties) {
    this(Integer.parseInt((String) properties.get("control.KSING")),
        Double.parseDouble((String) properties.get("control.ZTR")),
        Double.parseDouble((String) properties.get("control.XNEAR")),
        Double.parseDouble((String) properties.get("control.XFAR")),
        Double.parseDouble((String) properties.get("control.POS")),
        Integer.parseInt((String) properties.get("control.IQ")),
        Integer.parseInt((String) properties.get("control.KMS")),
        Integer.parseInt((String) properties.get("control.KFM")),
        Integer.parseInt((String) properties.get("control.IPUN")),
        Integer.parseInt((String) properties.get("control.IMAG")),
        Integer.parseInt((String) properties.get("control.IR")),
        Integer.parseInt((String) properties.get("control.IPRN")),
        Integer.parseInt((String) properties.get("control.KPAPER")),
        Integer.parseInt((String) properties.get("control.KTEST")),
        Integer.parseInt((String) properties.get("control.KAZ")),
        Integer.parseInt((String) properties.get("control.KSORT")),
        Integer.parseInt((String) properties.get("control.KSEL")),
        Integer.parseInt((String) properties.get("control.LAT1")),
        Integer.parseInt((String) properties.get("control.LAT2")),
        Double.parseDouble((String) properties.get("control.LON1")),
        Double.parseDouble((String) properties.get("control.LON2")));
  }
