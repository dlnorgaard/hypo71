...
public class Station implements Serializable {
  ...
  public static class TravelTimeResiduals implements Serializable {
    ...
    public TravelTimeResiduals(int nRES, double sRWT, double aVRES, double sDRES) {
      super();
      NRES = nRES;
      SRWT = sRWT;
      AVRES = aVRES;
  ...
  public Station(String NSTA, int NRES, double SRWT, double AVRES, double SDRES, int NRES1,
      double SRWT1, double AVRES1, double SDRES1, int NXM, double AVXM, double SDXM, int NFM,
  ...
  public Station(String nSTA, double dIST, int aIN, String pRMK, int hR, int mN, double pSEC,
      double tPOBS, double tPCAL, double dLYH1, String pRES, String pWT, double aMX, double pRX,
      double cALX, int k, double xMAG, double rMK, double fMP, double fMAG, String sRMK,
      double sSEC, double tSOBS, double sRES, double sWT, String dT) {
    super();
    NSTA = nSTA;
    DIST = dIST;
    AIN = aIN;
  ...
  public Station(String nSTA, double dly, double aZI, double eXGAP, double rDGAP) {
    this.NSTA = nSTA;
    this.dly = dly;
    this.AZI = aZI;
    this.EXGAP = eXGAP;
  ...
  public Station(char iW, String nSTA, int lAT1, double lAT2, char iNS, int lON1, double lON2,
      char iEW, int iELV, double dly, double fMGC, double xMGC, int kLAS, double pRR, double cALR,
      int iCAL, int nDATE, int nHRMN) {
    IW = iW;
    NSTA = nSTA;
    LAT1 = lAT1;
    LAT2 = lAT2;
  ...
  public Station(char iW, String nSTA, int lAT1, double lAT2, char iNS, int lON1, double lON2,
      char iEW, int iELV, int mNO, double dly, double dly1, double xMGC, double fMGC, int kLAS,
      double pRR, int iCAL, int nDATE, int nHRMN) {
    IW = iW;
    NSTA = nSTA;
    LAT1 = lAT1;
    LAT2 = lAT2;
