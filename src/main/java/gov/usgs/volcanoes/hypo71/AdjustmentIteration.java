...
public class AdjustmentIteration implements Serializable {
  ...
  public AdjustmentIteration(int nI, double sEC, int lALT1, double lAT2, int lON1, double lON2,
      double z, char rMK2, int iDMIN, double rMS, double aVRPS, char qS, int kF, char qD,
      double fLIM, double b1, double b0, double b2, double aF1, double aF0, double aF2, double sE1,
      double sE0, double sE2, double y1, double y0, double y2) {
    NI = nI;
    SEC = sEC;
    LALT1 = lALT1;
    LAT2 = lAT2;
