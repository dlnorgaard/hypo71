...
public class Stats implements Serializable {
  ...
  public Stats(double numInA, double numInB, double numInC, double numInD, double numTotal,
      double persentageInA, double persentageInB, double persentageInC, double persentageInD) {
    super();
    this.numInA = numInA;
    this.numInB = numInB;
    this.numInC = numInC;
